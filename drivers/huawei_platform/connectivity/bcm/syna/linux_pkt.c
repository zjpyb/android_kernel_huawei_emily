...
{
#ifdef CONFIG_DHD_USE_STATIC_SKBUF
#ifdef CONFIG_DHD_USE_STATIC_BUF
...
#endif /* CONFIG_DHD_USE_STATIC_BUF */
#endif /* CONFIG_DHD_USE_STATIC_SKBUF */
...
#if defined(CONFIG_DHD_USE_STATIC_BUF) &&  defined(CONFIG_DHD_USE_STATIC_SKBUF)
void*
osl_pktget_static(osl_t *osh, uint len)
{
	...
	printk("%s: all static pkt in use!\n", __FUNCTION__);
	return linux_pktget(osh, len);
#endif /* CONFIG_DHD_USE_STATIC_BUF && CONFIG_DHD_USE_STATIC_SKBUF */
}
