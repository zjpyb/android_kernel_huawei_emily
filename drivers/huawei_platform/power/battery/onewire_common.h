...
typedef struct {
    unsigned int reset_init_low_us;
    unsigned int reset_slave_response_delay_us;
    unsigned int reset_hold_high_us;
    unsigned int write_init_low_us;
    unsigned int write_hold_us;
    unsigned int write_residual_us;
    unsigned int read_init_low_us;
    unsigned int read_residual_us;
